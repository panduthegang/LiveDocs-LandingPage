export const features = [
  {
    ...
    text: "Live Docs makes collaboration a breeze. With real-time editing, commenting, and feedback sharing, your team stays in sync without missing a beat.",
  ...
  },
  {
    ...
    text: "At Live Docs, security is paramount. With top-notch encryption and privacy controls, your documents are locked down and protected at all times, giving you peace of mind.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "What is Live Docs?",
    answer:
      "Live Docs is an enhanced document editing platform that offers real-time collaboration, notifications, and comments for teams.",
  },
  {
    id: "1",
    question: "How does real-time collaboration work?",
    answer:
      "Users can edit documents simultaneously, and changes are instantly reflected for all team members, allowing seamless teamwork.",
      },
  {
    id: "2",
    question: "What features does Live Docs offer?",
    answer:
      "Key features include AI video editing, team collaboration, real-time notifications and comments, a fast cloud engine, and 24/7 customer support.",
  },
  {
    id: "3",
    question: "Is my data secure on Live Docs?",
    answer:
      "Yes, we implement robust security measures, including encryption and access controls, to ensure your data is protected.",
  },
  {
    id: "4",
    question: "Can I use Live Docs on mobile devices?",
    answer:
      "Yes, Live Docs is accessible on various devices, including smartphones and tablets, for on-the-go document editing.",
  },
  {
    id: "5",
    question: "What kind of support is available?",
    answer:
      "We offer 24/7 customer support via chat and email to assist you with any questions or issues you may encounter.",
  },
  {
    id: "6",
    question: "How do I invite team members to collaborate?",
    answer:
      "You can easily invite team members by sharing a document link or sending them an email invitation directly through the platform.",
  },
  {
    id: "7",
    question: "Can multiple users work on the same document simultaneously?",
    answer:
      "Yes, multiple users can collaborate on the same document in real time, making it easy to work together and share ideas instantly.",
  },
  {
    id: "8",
    question: "Can I integrate Live Docs with other tools?",
    answer:
      "No, Live Docs currently does not support integrations with other tools, ensuring a streamlined experience within the platform.",
  },
  {
    id: "9",
    question: "How is my data backed up on Live Docs?",
    answer:
      "All documents in Live Docs are automatically saved and backed up in the cloud, ensuring your work is secure and accessible from anywhere at any time.",
  },
];
...
export const testimonials = [
  {
    ...
    avatarUrl: "/images/testimonials/Shivansu.png",
    comment:
      "LiveDocs customer support is second to none! They’re like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Saurabh Patel",
    role: "Operations Manager",
    avatarUrl: "/images/testimonials/Saurabh.png",
    comment:
      "Finally, a document editor that feels intuitive and powerful. Live Docs makes teamwork effortless!",
  },
  {
    id: "2",
    name: "Vedangi Pathre",
    role: "Software Developer",
    avatarUrl: "/images/testimonials/Vedangi.png",
    comment:
  ...
  },
  {
    ...
    avatarUrl: "/images/testimonials/Rishi.png",
    comment:
  ...
  },
  {
    ...
    name: "Nishchay Patil",
    role: "Team Leader",
    avatarUrl: "/images/testimonials/Nishchay.png",
    comment:
      "Switched to LiveDocs last month, and I'm already seeing results. Best decision for our team!",
  },
  {
    id: "5",
    name: "Shyam Pathak",
    role: "Project Coordinator",
    avatarUrl: "/images/testimonials/Shyam.png",
    comment:
